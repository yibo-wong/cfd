...
from splitflux import roe_split_x, roe_split_y
import time
from weno import weno5_flux, apply_boundary_condition
import os

os.makedirs("./fig/roe/gif", exist_ok=True)
...
def plot_mesh(mesh_x, mesh_y):
    ...
    plt.xlabel('x')
    plt.ylabel('y')
    plt.savefig("./fig/roe/mesh.png", dpi=300)
    plt.show()
...
def draw_gif():
    ...
    gif_path = './fig/roe/gif/output.gif'
